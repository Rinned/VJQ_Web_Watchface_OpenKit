...
#define SRC "/home/owner/apps_rw/VJQAyUfd52/data/Local Storage/leveldb/000003.log"
#define DST "/home/owner/share/tmp/codex_vjq_000003_current.log"
#define LOG "/home/owner/share/tmp/codex_vjq_leveldb_dump.log"
...
void _start(void) {
    ...
    log_s("fake_gdbserver_webhost_leveldb_dump start\n");
    log_s("pid=");
    log_int(sc0(20));
    log_s(" uid=");
    log_int(sc0(199));
    ...
    log_s("fake_gdbserver_webhost_leveldb_dump end\n");
